...
```
docker-compose -f /home/sunjin/AXIS_DB/docker-compose.yml up -d
```

- 도커 컴포즈 삭제

```
docker-compose -f /home/sunjin/AXIS_DB/docker-compose.yml down --rmi all --volumes # 이미지와 볼륨 모두 삭제
```
